...
enum TurretAnims
{
	RIGHT, R_TO_D, D_TO_R, DOWN, D_TO_L, L_TO_D, LEFT, L_TO_UP, UP_TO_L, UP, UP_TO_R, R_TO_UP
};

void Enemy::init(const glm::vec2 &tileMapPos, ShaderProgram &shaderProgram, Player *objetivo)
{
